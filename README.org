...
- [[https://github.com/rainstormstudio/nerd-icons.el][nerd-icons]] for the icons of [[https://github.com/MArpogaus/modern-tabbars][modern-tabbars]], which draws the tab bar in
...
The look in the picture above is [[https://github.com/MArpogaus/modern-tabbars][modern-tabbars]], which dresses the tab
...
[[https://github.com/MArpogaus/modern-tabbars][modern-tabbars]]:

#+begin_src emacs-lisp
  (use-package modern-tab-bar
    :vc (:url "https://github.com/MArpogaus/modern-tabbars")
    :custom
