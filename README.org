...
- [[https://github.com/rainstormstudio/nerd-icons.el][nerd-icons]] for the icons of [[https://github.com/MArpogaus/modern-tab-bars][modern-tab-bars]], which draws the tab bar in
...
The look in the picture above is [[https://github.com/MArpogaus/modern-tab-bars][modern-tab-bars]], which dresses the tab
